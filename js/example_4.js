...
<code><span class="line-1">async def main():</span>
    ...
    <span class="line-4">result2 = await task2</span>
    <span class="line-5">print("Task 2 fully completed")</span>
    <span class="line-6">result1 = await task1</span>
    <span class="line-7">print("Task 1 fully completed")</span>
...
<code><span class="line-1">async def fetch_data(param):</span>
  ...
  const steps = [
    ...
    () => {
      elements.outputLine5.innerHTML = `Task 2 fully completed`;
    },
    () => {
    ...
    () => {
      elements.outputLine6.innerHTML = `Task 1 fully completed`;
    },
    () => {
